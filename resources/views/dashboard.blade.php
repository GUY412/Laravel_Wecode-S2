...
@section('content')
    ...
    <div class="p-6">
        ...
        <div class="flex items-center justify-between my-4">
            <a href="{{ route('articles.create') }}" class="py-2 px-4 bg-blue-500 hover:bg-green-700 text-white rounded-md">
                Créer un article
            </a>
            <div class="p-6">
            ...
            <div class="p-6">
                @csrf
                <a class="py-2 px-4 bg-gray-500 hover:bg-gray-700 text-white rounded-md" href="{{ route('profile') }}">
                    Profile
                </a>
            </div>
        </div>
            ...
            @foreach ($articles as $article)
                    ...
                    <li class="border border-gray-300 p-2 my-2">
                        ...
                        <div class="flex items-center gap-2 w-full mt-6">
                            <a href="{{ route('articles.edit', $article->id) }}"
                                class="text-white bg-yellow-500 hover:bg-yellow-600 px-4 py-1
                ...
                rounded-md">
                            ...
                            <a href="{{ route('articles.show', $article->id) }}"
                                class="text-white bg-blue-500 hover:bg-blue-800 px-4
            py-1 rounded-md">Lire
                                l'article</a>
                    </li>
    </div>
    </li>
